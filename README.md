[![npm version](https://img.shields.io/npm/v/@m7eio/mongo-graphql-starter.svg?style=flat)](https://www.npmjs.com/package/@m7eio/mongo-graphql-starter)
[![codecov](https://codecov.io/gh/arackaf/@m7eio/mongo-graphql-starter/branch/master/graph/badge.svg?token=1HSB4GBI49)](https://codecov.io/gh/arackaf/@m7eio/mongo-graphql-starter)
[![code style: prettier](https://img.shields.io/badge/code_style-prettier-ff69b4.svg)](https://github.com/prettier/prettier)


# @m7eio/mongo-graphql-starter
...
- [@m7eio/mongo-graphql-starter](#m7eiomongo-graphql-starter)
  - [Prior art](#prior-art)
...
```javascript
import { dataTypes } from "@m7eio/mongo-graphql-starter";
const {
  MongoIdType,
  MongoIdArrayType,
  StringType,
...
```javascript
import { createGraphqlSchema } from "@m7eio/mongo-graphql-starter";
...
Here are the valid types you can import from `@m7eio/mongo-graphql-starter`
...
```javascript
import { settings } from "@m7eio/mongo-graphql-starter";
